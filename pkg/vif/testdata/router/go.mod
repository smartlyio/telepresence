...
require (
	...
	github.com/telepresenceio/telepresence/v2 v2.22.3
)
...
require (
	...
	github.com/telepresenceio/telepresence/rpc/v2 v2.22.4-rc.1 // indirect
	...
	gvisor.dev/gvisor v0.0.0-20250421234849-d561420079a1 // indirect
